...
export default function GarantiasContent() {
  return (
    <div>
      ...
      <div className="mb-3">
        <p className="mb-1">
          ➡️ <strong>Garantía Apple</strong>
        </p>
      ...
      <div className="mb-3">
        <p className="mb-1">
          ➡️ <strong>Garantía smartphones</strong>
        </p>
        <p className="mb-1">Período de cobertura: 3 Meses</p>
        <p className="mb-1">
          Servicio técnico propio, opera en caso de fallas de hardware (defectos de fabricación)
        </p>
        <p className="mb-2">
          <em>
            +info:{' '}
      ...
      <div>
        <p className="mb-1">
          ➡️ <strong>Garantía otros productos</strong>
        </p>
        <p className="mb-1">Período de cobertura: 3 Meses</p>
